...
class GHApp < Sinatra::Application
  ...
  helpers do
    ...
    # Protects the master branch ( assumption made here as we will not get the 
    # default branch name in the payload for installation event) 
    ...
    # Handles when an app is installed in an org, or a repo is created or a pull 
    # request is created
    ...
    def authenticate_installation(payload)
      ...
      #logger.debug "---- installation_token #{@installation_token}"
    ...
    def verify_webhook_signature
      ...
      #logger.debug "---- their_digest #{their_digest}"
